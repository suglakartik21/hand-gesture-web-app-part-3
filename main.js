...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/nfpDfYHsI/model.json',modelLoaded);
...
function gotResults(error, results){
    if(error){
        ...
        if(results[0].label == "Rock and Cool"){
            document.getElementById("result_emoji").innerHTML = "&#129304;";
